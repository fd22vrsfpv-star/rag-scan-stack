...
class Tools:
    ...
    def start_nmap_scan(self, target: str, scan_type: str = "default", ports: str = None) -> str:
        ...
        if ports:
            data["ports"] = ports
        try:
            r = requests.post("https://nmap_scanner:8012/scan", json=data, timeout=30)
    ...
    def start_masscan(self, target: str, ports: str = "1-65535", rate: int = 1000) -> str:
        ...
        try:
            r = requests.post("https://nmap_scanner:8012/masscan",
                json={"target": target, "ports": ports, "rate": rate}, timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def start_nuclei_scan(self, target: str, severity: str = None) -> str:
        ...
        try:
            r = requests.post("https://nuclei-runner:8011/scan", json=data, timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def start_web_scan(self, target_url: str, wordlist: str = "common") -> str:
        ...
        try:
            r = requests.post("https://web-scanner:8010/scan",
                json={"target_url": target_url, "wordlist": wordlist}, timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def start_playwright_scan(self, target_url: str) -> str:
        ...
        try:
            r = requests.post("https://playwright-scanner:8014/scan",
                json={"url": target_url}, timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_nmap_status(self, job_id: str) -> str:
        ...
        """
        try:
            r = requests.get(f"https://nmap_scanner:8012/job/{job_id}", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_nuclei_status(self, job_id: str) -> str:
        ...
        """
        try:
            r = requests.get(f"https://nuclei-runner:8011/job/{job_id}", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_web_scan_status(self, job_id: str) -> str:
        ...
        """
        try:
            r = requests.get(f"https://web-scanner:8010/job/{job_id}", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def run_msf_module(self, module_path: str, rhosts: str, rport: int = None, payload: str = None) -> str:
        ...
        try:
            r = requests.post("https://exploit-runner:8017/run_msf", json=data, timeout=60)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def run_edb_script(self, edb_id: str, target: str, options: str = None) -> str:
        ...
        try:
            r = requests.post("https://exploit-runner:8017/run_edb", json=data, timeout=60)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def list_msf_sessions(self) -> str:
        ...
        """
        try:
            r = requests.get("https://exploit-runner:8017/sessions", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def run_session_command(self, session_id: str, command: str) -> str:
        ...
        try:
            r = requests.post("https://exploit-runner:8017/session_command",
                json={"session_id": session_id, "command": command}, timeout=60)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def list_msf_jobs(self) -> str:
        ...
        """
        try:
            r = requests.get("https://exploit-runner:8017/msf_jobs", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_msf_status(self) -> str:
        ...
        """
        try:
            r = requests.get("https://exploit-runner:8017/status", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_session_status(self, session_id: str) -> str:
        ...
        """
        try:
            r = requests.get(f"https://autogen-agents:8015/session/{session_id}", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_session_messages(self, session_id: str) -> str:
        ...
        """
        try:
            r = requests.get(f"https://autogen-agents:8015/session/{session_id}/messages", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def list_sessions(self, status: str = None) -> str:
        ...
        try:
            r = requests.get("https://autogen-agents:8015/sessions", params=params, timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def stop_session(self, session_id: str) -> str:
        ...
        """
        try:
            r = requests.post(f"https://autogen-agents:8015/session/{session_id}/stop", timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
    ...
    def get_recommendation(self, target: str = None) -> str:
        ...
        params = {"target": target} if target else {}
        try:
            r = requests.get("https://scan-recommender:8013/recommend", params=params, timeout=30)
            return json.dumps(r.json(), indent=2)
        except Exception as e:
            return f"Error: {e}"
